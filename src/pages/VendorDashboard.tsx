...
export function VendorDashboard() {
  ...
  // Per-vendor stats — pending payout comes directly from payouts table records
  ...
  // Total pending payouts = sum of actual pending payout records (matches Payouts page)
